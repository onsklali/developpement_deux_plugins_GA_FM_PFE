...
function FavizoneAppender(element_gender, element_identifier) {
  ...
  this.appendFavizoneElement = function() {
	...
	if (section) {
	  ...
	  section.insertAdjacentHTML('afterbegin', '<div class="clearfix"></div>' + element.outerHTML + '<div class="clearfix"></div>');

	  element.setAttribute("id", "favizone_" + this.element_gender + "_bottom_element");
	  section.insertAdjacentHTML('beforeend', '<div class="clearfix"></div>' + element.outerHTML + '<div class="clearfix"></div>');
	}
  }
}